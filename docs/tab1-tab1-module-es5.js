...
var Tab1Page = /** @class */ (function () {
    ...
    Tab1Page.prototype.getImagePath = function (item) {
        return "" + "/assets/menu/" + item.image;
    };
    Tab1Page.prototype.finishOrder = function (item) {
        this.orderList = this.orderList.filter(function (el) { return el.id !== item.id; });
    };
    Tab1Page.prototype.checkNoOrders = function () {
